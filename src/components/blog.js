...
export default function blog(){
    ...
    <div className="col">
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p />
          <p className="card-text">
            Why choose Certified Compostable over Degradable or Biodegradable? Quite simply, certified compostable is the only option of these three that breaks down into natural components and does not leave harmful microplastics in the environment and food chain. Sometimes these terms are used interchangeably, which can be very confusing, and often when used in a commercial […]
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="outer"> 
    ...
    <p className="text"> 
      ...
      Are some people more susceptible to UV damage than others?<br /><br />
      ...
      What is the best way to deal with both types of UV? <br /><br />
  ...
  <br />
  <br />
  <h1>How to inculcate Sustainable lifestyle </h1>
  <div className="row mt-5">
    <div className="col">
      <div className="card">
        <div className="video">
        ...
        <div className="card-body">
          ...
          <p />
          <p className="card-text"> for more tips on how to incorporate sustainable practices in your life, ... But, if DIY just isn't your thing or ...
          </p>
        </div>
      </div>
    </div>
