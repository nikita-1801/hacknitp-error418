...
export default function blog(){
      ...
      <div className="col-md-3 column">
        <div className="card1">
          ...
          <div className="card1-body">
            ...
            <p className="card1-text category">
              Composting
            </p>
          </div>
        </div>
  ...
  <div className="container">
    <img src="susbg6.jfif" alt="Snow" style={{width: '100%'}} />
    ...
    <div className="top-right">
      ...
      <p>Whether that’s being more mindful of what you buy at the grocery store, or how you might do ‘gifting’ for family and friends during the holiday season, better buying decisions can have a ripple effect on people and our planet.</p>
      <p>It’s these small actions we take, that can help to leave the world a more just, equitable, and habitable place for all of us, not just some of us.</p>
    </div>
